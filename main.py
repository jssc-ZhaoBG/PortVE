...
from models.ConvIR1 import build_net
...
if __name__ == '__main__':
    ...
    parser.add_argument('--data_dir', type=str, default='F:/Datasets/reside/reside-outdoor/')
    ...
    # Test
    parser.add_argument('--test_model', type=str, default='D:/codes/others/SIENet/Best.pkl')
